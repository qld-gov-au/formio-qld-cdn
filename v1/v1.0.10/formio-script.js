...
;// CONCATENATED MODULE: ./src/helpers/FormioScript/index.prod.js

const scripts = [{
  type: "script",
  src: `https://static.qgov.net.au/formio-qld/${defaultVersion}/formio.full.min.js`,
  async: false
}, {
  type: "script",
  src: `https://static.qgov.net.au/formio-qld/${defaultVersion}/premium.min.js`,
  async: false
}, {
  type: "script",
  src: `https://static.qgov.net.au/formio-qld/${defaultVersion}/formio-qld.min.js`,
  async: false
}, // note: formio-loader should always load last
{
  type: "script",
  src: `https://static.qgov.net.au/formio-qld/${defaultVersion}/formio-loader.min.js`,
  async: false
}, {
  type: "link",
  href: `https://static.qgov.net.au/formio-qld/${defaultVersion}/formio.full.min.css`,
  rel: "stylesheet"
}, {
  type: "link",
  href: `https://static.qgov.net.au/formio-qld/${defaultVersion}/premium.css`,
  rel: "stylesheet"
}, {
  type: "link",
